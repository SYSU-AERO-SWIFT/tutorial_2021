...
SVector3 little_cars::get_velocity()
{
	return this->_velocity;
}

SVector3 little_cars::get_position()
{
	return this->_position;
}
void little_cars::set_velocity(SVector3 velocity)
{
...
void little_cars::set_noise_level(int level)
{
	_noise_level = level;
}
void little_cars::update_position()
{
...
void little_cars::set_yaw(double yaw)
{
	_yaw = yaw;
	return;
}
