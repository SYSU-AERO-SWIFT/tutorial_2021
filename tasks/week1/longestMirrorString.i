...
# 4 "longestMirrorString.cpp" 2

# 4 "longestMirrorString.cpp"
using namespace std;
...
{
 vector<string> vec_longest_string;
 int max=0;
 for (int i = 0; i < strs.length(); i++)
 {
  string temp_strs1;
  string temp_strs2;
  temp_strs1 = getsubstring(strs, i, i);
  temp_strs2 = getsubstring(strs, i, i + 1);
