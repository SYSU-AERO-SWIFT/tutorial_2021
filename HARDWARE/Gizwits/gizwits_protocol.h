...
* @{
*/
#define PRODUCT_KEY "216a22b196e8485e9f6bae261528d2ad"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "429efe32dd064a56bdc079d8637e0a94"
...
#define steer1_RATIO                         1
#define steer1_ADDITION                      0
#define steer1_MIN                           0
#define steer1_MAX                           180
#define steer2_RATIO                         1
#define steer2_ADDITION                      0
#define steer2_MIN                           0
#define steer2_MAX                           180
#define steer3_RATIO                         1
#define steer3_ADDITION                      0
#define steer3_MIN                           0
#define steer3_MAX                           180
#define steer4_RATIO                         1
#define steer4_ADDITION                      0
#define steer4_MIN                           0
#define steer4_MAX                           180
#define state1_RATIO                         1
#define state1_ADDITION                      0
#define state1_MIN                           0
#define state1_MAX                           180
#define state2_RATIO                         1
#define state2_ADDITION                      0
#define state2_MIN                           0
#define state2_MAX                           180
#define state3_RATIO                         1
#define state3_ADDITION                      0
#define state3_MIN                           0
#define state3_MAX                           180
#define state4_RATIO                         1
#define state4_ADDITION                      0
#define state4_MIN                           0
#define state4_MAX                           180
/**@} */
...
typedef struct {
  uint32_t valuesteer1;
  uint32_t valuesteer2;
  uint32_t valuesteer3;
  uint32_t valuesteer4;
  uint32_t valuestate1;
  uint32_t valuestate2;
  uint32_t valuestate3;
  uint32_t valuestate4;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagsteer1:1;
  uint8_t flagsteer2:1;
  uint8_t flagsteer3:1;
  uint8_t flagsteer4:1;
} attrFlags_t;
